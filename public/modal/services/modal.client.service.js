// manages the modal in the application
angular.module('modal').service("modals", function($rootScope, $q){

  //current active modal window instance
  var modal = {
    deferred: null,
    params: null
  };
